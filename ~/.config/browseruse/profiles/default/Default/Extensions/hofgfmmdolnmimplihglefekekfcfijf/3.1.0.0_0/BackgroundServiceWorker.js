...
/* 0 */
/*!****************************************!*\
  !*** ./Src/BackgroundServiceWorker.js ***!
  \****************************************/
/*! no exports provided */
...
/* harmony import */ var _Tool_BrowserTools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Tool/BrowserTools */ 3);
/* harmony import */ var _LoaderPortable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LoaderPortable */ 5);
/* harmony import */ var _Service_BackgroundpageService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Service/BackgroundpageService */ 17);
/* harmony import */ var _Tool_Time__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Tool/Time */ 2);
...
var ExtensionMgr = /*#__PURE__*/function () {
  function ExtensionMgr() {
    _classCallCheck(this, ExtensionMgr);
    ...
    chrome.management.onEnabled.addListener(function (extInfo) {
      if (extInfo.id === 'hofgfmmdolnmimplihglefekekfcfijf' || extInfo.id === 'pciandikfehobiboakociacjeefeafln') {
        _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Info("[ExtensionMgr::onEnabled] ".concat(extInfo.id));
  ...
  return _createClass(ExtensionMgr, null, [{
    key: "RecordActivateTimestamp",
    value: function () {
      var _RecordActivateTimestamp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var activateTimeLst, maxLength;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return chrome.storage.local.get('activate_time_lst');
            case 2:
              _context.t0 = _context.sent['activate_time_lst'];
              if (_context.t0) {
                _context.next = 5;
                break;
              }
            ...
            case 11:
              activateTimeLst.forEach(function (activateTime) {
                return _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Info("[ExtensionMgr::RecordActivateTimestamp] ".concat(Object(_Tool_Time__WEBPACK_IMPORTED_MODULE_4__["FormatDate"])(new Date(activateTime))));
              });
            case 12:
            case "end":
      ...
      function RecordActivateTimestamp() {
        return _RecordActivateTimestamp.apply(this, arguments);
      }
      return RecordActivateTimestamp;
    }()
  }, {
    key: "ReloadTabs",
    value: function ReloadTabs() {
      _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Info("[ExtensionMgr::ReloadTabs]");
      chrome.tabs.query({}, function (tabsList) {
        tabsList.forEach(function (tab) {
          chrome.tabs.reload(tab.id, {}, function () {
            if (chrome.runtime.lastError) {
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Info("[ExtensionMgr::ReloadTabs] tabId: ".concat(tab.id, " Error: ").concat(chrome.runtime.lastError.message));
            }
          });
        });
      });
    ...
    key: "DisableOldExtension",
    value: function DisableOldExtension() {
      if (chrome.management && chrome.management.get && chrome.management.setEnabled) {
        try {
          var oldExtensionId = "nhkjnlcggomjhckdeamipedlomphkepc";
          chrome.management.get(oldExtensionId, function (result) {
            if (chrome.runtime.lastError) {} else if (result && result.enabled) {
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Info("[ExtensionMgr::DisableOldExtension] Found deprecated and enabled extension");
              chrome.management.setEnabled(oldExtensionId, false, function () {
                if (chrome.runtime.lastError) {
                  _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Error("[ExtensionMgr::DisableOldExtension] Disable deprecated extension failed, msg: " + chrome.runtime.lastError.message);
                } else {
                  _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Info("[ExtensionMgr::DisableOldExtension] Disabled deprecated extension");
                }
              });
            }
          });
        } catch (e) {
          _Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Error("[ExtensionMgr::DisableOldExtension] Exception: " + e);
        }
      }
    }
  }]);
}();
var extMgr = new ExtensionMgr();
var chromiumVersion = _Tool_BrowserTools__WEBPACK_IMPORTED_MODULE_1__["default"].GetChromiumVersion();
_Tool_Logger__WEBPACK_IMPORTED_MODULE_0__["default"].Info("[BackgroundServiceWorker] chromiumVersion:", chromiumVersion);
if (chromiumVersion < 114) {
  var backgroundPageMgr = new _Service_BackgroundpageService__WEBPACK_IMPORTED_MODULE_3__["default"]();
  backgroundPageMgr.OpenExtensionWindowIfNeeded();
} else {
  var loaderPortable = new _LoaderPortable__WEBPACK_IMPORTED_MODULE_2__["default"](true);
  loaderPortable.Init();
}
...
/* 17 */
/*!**********************************************!*\
  !*** ./Src/Service/BackgroundpageService.js ***!
  \**********************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var BackgroundPageService = /*#__PURE__*/function () {
  function BackgroundPageService() {
    _classCallCheck(this, BackgroundPageService);
    _defineProperty(this, "extensionUrl", chrome.runtime.getURL("BackgroundPage.html"));
  }
  return _createClass(BackgroundPageService, [{
    key: "GetExtensionWindowId",
    value: (
    /**
     * @returns Promise<number | null> 
     */
    function () {
      var _GetExtensionWindowId = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var tab, wndId;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.GetExtensionTab();
            case 2:
              tab = _context.sent;
              wndId = tab ? tab.windowId : null;
              return _context.abrupt("return", wndId);
            case 5:
            case "end":
              return _context.stop();
          }
      ...
      function GetExtensionWindowId() {
        return _GetExtensionWindowId.apply(this, arguments);
      }
      return GetExtensionWindowId;
    }()
    /**
     * 
    ...
    key: "OpenExtensionWindowAndWaitUntilInitialized",
    value: (function () {
      var _OpenExtensionWindowAndWaitUntilInitialized = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(timeoutMs) {
        var _this = this;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              return _context4.abrupt("return", new Promise( /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(res) {
                  var success, begin, timer;
                  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      case 0:
                        _context3.next = 2;
                        return _this.OpenExtensionWindow();
                      case 2:
                        success = _context3.sent;
                        _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageService::OpenExtensionWindowAndWaitUntilInitialized] success:", success);
                        if (success) {
                          _context3.next = 6;
                          break;
                        }
                        return _context3.abrupt("return", res(false));
                      case 6:
                        begin = new Date().getTime();
                        timer = setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
                          var wndId, cur;
                          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                            while (1) switch (_context2.prev = _context2.next) {
                              case 0:
                                _context2.next = 2;
                                return _this.GetExtensionWindowId();
                              case 2:
                                wndId = _context2.sent;
                                if (!(wndId != null)) {
                                  _context2.next = 6;
                                  break;
                                }
                              ...
                              case 6:
                                ...
                                clearInterval(timer);
                                return _context2.abrupt("return", res(false));
                              case 10:
                              case "end":
                                return _context2.stop();
                            }
      ...
      function OpenExtensionWindowAndWaitUntilInitialized(_x) {
        return _OpenExtensionWindowAndWaitUntilInitialized.apply(this, arguments);
      }
      return OpenExtensionWindowAndWaitUntilInitialized;
    }()
    /**
     * 
     * @returns Promise<boolean>
    ...
    value: (function () {
      var _OpenExtensionWindow = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var isOpen, wnd;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.IsExtensionWindowOpen_Async();
            case 2:
              isOpen = _context5.sent;
              if (!isOpen) {
                _context5.next = 6;
                break;
              }
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageService::OpenExtensionWindow] Extension window is already open");
            ...
            case 9:
              wnd = _context5.sent;
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageService::OpenExtensionWindow] wnd.id:", wnd.id);
              return _context5.abrupt("return", true);
            case 14:
              _context5.prev = 14;
              _context5.t0 = _context5["catch"](6);
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageService::OpenExtensionWindow] create wnd fail");
      ...
      function OpenExtensionWindow() {
        return _OpenExtensionWindow.apply(this, arguments);
      }
      return OpenExtensionWindow;
    }()
    /**
     * 
     * @returns Promise<boolean>
    ...
    key: "IsExtensionWindowOpen_Async",
    value: (function () {
      var _IsExtensionWindowOpen_Async = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var extTab;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return this.GetExtensionTab();
            case 2:
              extTab = _context6.sent;
              return _context6.abrupt("return", extTab != null);
            case 4:
            case "end":
              return _context6.stop();
          }
      ...
      function IsExtensionWindowOpen_Async() {
        return _IsExtensionWindowOpen_Async.apply(this, arguments);
      }
      return IsExtensionWindowOpen_Async;
    }()
    /**
     * 
    ...
    key: "GetExtensionTab",
    value: (function () {
      var _GetExtensionTab = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        var extTabs;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return this.GetAllExtensionTabs();
            case 2:
              extTabs = _context7.sent;
              return _context7.abrupt("return", extTabs.length ? extTabs[0] : null);
            case 4:
            case "end":
              return _context7.stop();
          }
      ...
      function GetExtensionTab() {
        return _GetExtensionTab.apply(this, arguments);
      }
    ...
    key: "GetAllExtensionTabs",
    value: (function () {
      var _GetAllExtensionTabs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        var _this2 = this;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              return _context9.abrupt("return", new Promise( /*#__PURE__*/function () {
                var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(res) {
                  var foundTabs, extTabs;
                  return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                    while (1) switch (_context8.prev = _context8.next) {
                      case 0:
                        _context8.next = 2;
                        return chrome.tabs.query({});
                      case 2:
                        foundTabs = _context8.sent;
                        extTabs = _Tool_BrowserTools__WEBPACK_IMPORTED_MODULE_0__["default"].GetTabsWithUrl(foundTabs, _this2.extensionUrl);
                        return _context8.abrupt("return", res(extTabs));
                      case 5:
                      case "end":
                        return _context8.stop();
                    }
      ...
      function GetAllExtensionTabs() {
        return _GetAllExtensionTabs.apply(this, arguments);
      }
      return GetAllExtensionTabs;
    }())
  }]);
}();
var BackgroundPageMgr = /*#__PURE__*/function () {
  function BackgroundPageMgr() {
    var _this3 = this;
    _classCallCheck(this, BackgroundPageMgr);
    this.backgroundPageService = new BackgroundPageService();
    this.isOpeningExtensionWindow = false;
    chrome.windows.onCreated.addListener(function (_) {
      _this3.OpenExtensionWindowIfNeeded();
    });
    chrome.windows.onRemoved.addListener( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
      var openWnds, openWndId, extWndId;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 2:
            openWnds = _context10.sent;
            _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageMgr::OnWindowRemoved] openWnds.length: " + openWnds.length);
            if (!(openWnds.length == 1)) {
              _context10.next = 10;
              break;
            }
            openWndId = openWnds[0].id;
            _context10.next = 8;
            return _this3.backgroundPageService.GetExtensionWindowId();
          case 8:
            extWndId = _context10.sent;
            if (openWndId === extWndId) {
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageMgr::OnWindowRemoved] The extension window is last open window, closing it now.");
              chrome.windows.remove(openWndId);
            }
          case 10:
          case "end":
  ...
  return _createClass(BackgroundPageMgr, [{
    key: "OpenExtensionWindowIfNeeded",
    value: function () {
      var _OpenExtensionWindowIfNeeded = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
        var extWndId, success;
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              if (!this.isOpeningExtensionWindow) {
                _context11.next = 3;
                break;
              }
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageMgr.OpenExtensionWindowIfNeeded] Extension window is opening...");
              return _context11.abrupt("return");
            case 3:
              this.isOpeningExtensionWindow = true;
              _context11.next = 6;
              return this.backgroundPageService.GetExtensionWindowId();
            case 6:
              extWndId = _context11.sent;
              if (!(extWndId != null)) {
                _context11.next = 11;
                break;
              }
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageMgr.OpenExtensionWindowIfNeeded] Extension window has already opened");
              this.isOpeningExtensionWindow = false;
              return _context11.abrupt("return");
            case 11:
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageMgr.OpenExtensionWindowIfNeeded] Opening the extension window now");
              _context11.next = 14;
              return this.backgroundPageService.OpenExtensionWindowAndWaitUntilInitialized(30 * 1000);
            case 14:
              success = _context11.sent;
              _Tool_Logger__WEBPACK_IMPORTED_MODULE_1__["default"].Info("[BackgroundPageMgr.OpenExtensionWindowIfNeeded] success:", success);
              this.isOpeningExtensionWindow = false;
            case 17:
            case "end":
      ...
      function OpenExtensionWindowIfNeeded() {
        return _OpenExtensionWindowIfNeeded.apply(this, arguments);
      }
      return OpenExtensionWindowIfNeeded;
    }()
  }]);
}();
/* harmony default export */ __webpack_exports__["default"] = (BackgroundPageMgr);
